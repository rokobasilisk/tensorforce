...
class GodotEnvironment(RemoteEnvironment, StateSettableEnvironment):
    """
    A special RemoteEnvironment for Godot game connections.
    Communicates with the remote to receive information on the definitions of action- and observation spaces.
    Sends Godot Actions as RL-actions and receives observations back defined by TFEnvironment
    ...
    def __str__(self):
        return "GodotEnvironment({}:{}{})".format(self.host, self.port, "[connected; {}]".
